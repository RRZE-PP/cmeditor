class CmeditorGrailsPlugin {
    ...
    def description = 'CMEditor is a simple way to easily use the popular CodeMirror web editor in grails applications'
    def documentation = "https://github.com/RRZE-PP/grails-cmeditor"
    def license = "APACHE"
